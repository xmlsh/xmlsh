...
public class XTypeUtils {
  ...
  public static IXValueMap newMapFromList(List<XValue> value)
  ...
  public static XValueMap newMapFromProperties(Properties props) {
    ...
    for(Iterator<Entry<Object, Object>> iterator = props.entrySet()
  ...
  public static XValueMap newMapFromValue(XValue value)
      throws InvalidArgumentException {
  ...
  public static org.xmlsh.util.XNamedValue newNamedValue(XValue arg)
      throws InvalidArgumentException {
    ...
    if(arg.isAtomic()) {
      ...
      return new org.xmlsh.util.XNamedValue(pair.getLeft(),
          XValue.newXValue(pair.getRight()));
    }
    else {
