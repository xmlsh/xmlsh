...
public class xbase extends XCommand {
  ...
  public int run(List<XValue> args)
    ...
    XMLStreamReader reader = args.isEmpty()
        ? getStdin().asXMLStreamReader(sopts)
    ...
    String sBase = reader.getAttributeValue(mBaseQName.getNamespaceURI(),
        mBaseQName.getLocalPart());
