...
public class xwc extends XCommand {
  ...
  private void output(XMLStreamWriter writer) throws XMLStreamException {
    ...
    write(writer, "start-element",
        counts[XMLStreamConstants.START_ELEMENT - 1]);
    write(writer, "end-element", counts[XMLStreamConstants.END_ELEMENT - 1]);
    write(writer, "processing-instruction",
        counts[XMLStreamConstants.PROCESSING_INSTRUCTION - 1]);
    ...
    write(writer, "start-document",
        counts[XMLStreamConstants.START_DOCUMENT - 1]);
    write(writer, "end-document", counts[XMLStreamConstants.END_DOCUMENT - 1]);
    write(writer, "entity-reference",
        counts[XMLStreamConstants.ENTITY_REFERENCE - 1]);
    ...
    write(writer, "notation-decl",
        counts[XMLStreamConstants.NOTATION_DECLARATION - 1]);
    write(writer, "entity-decl",
        counts[XMLStreamConstants.ENTITY_DECLARATION - 1]);
  ...
  private void write(XMLStreamWriter writer, String localName, int n)
