...
public class xcat extends XCommand {
  ...
  public int run(List<XValue> args) throws Exception {
    ...
    writer.add(
        mFactory.createStartDocument(serializeOpts.getOutputXmlEncoding()));
  ...
  private void write(InputPort in, XMLEventWriter writer, boolean bRemoveRoot,
      SerializeOpts opts) throws CoreException, XMLStreamException {
    ...
    while(reader.hasNext()) {
      ...
      else if(depth == 1 && bRemoveRoot && event.isCharacters()
  ...
  private void writeWrapperStart(XValue wrapper, XMLEventWriter writer,
      SerializeOpts opts)
      throws XMLStreamException, CoreException, IOException {
    if(wrapper.isAtomic())
      writer.add(mFactory.createStartElement(new QName(wrapper.toString()),
          null, null));
  ...
  private void writeWrapperEnd(XValue wrapper, XMLEventWriter writer,
      SerializeOpts opts)
      throws XMLStreamException, CoreException, IOException {
    if(wrapper.isAtomic())
      writer
          .add(mFactory.createEndElement(new QName(wrapper.toString()), null));
