...
public class xuri extends XCommand {
  ...
  public int run(List<XValue> args) throws Exception {
    ...
    Options opts = new Options(
        "a=authority,f=fragment,h=host,p=path,P=port,q=query,s=scheme,r=resource:,Q",
    ...
    if(opts.hasOpt("r")) {
      ...
      URL url = getEnv().getShell().getResource(res);
      if(url == null)
