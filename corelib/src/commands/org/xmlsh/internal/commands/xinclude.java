...
public class xinclude extends XCommand {
  ...
  public int run(List<XValue> args) throws Exception {
    ...
    Options opts = new Options("xs=xomserialize",
    ...
    Document input = builder.build(stdin.asInputStream(sopts),
        stdin.getSystemId());
    ...
    if(xs) {
      ...
      ContentHandlerToXMLStreamWriter handler = new ContentHandlerToXMLStreamWriter(
          w);
