...
abstract class AbstractMethods implements IMethods
{

	private IType mType ;

	protected AbstractMethods(IType type)
	{
		assert(type != null);
		mType = type;
	}
	...
	@Override
	public XValue append(Object o , XValue v)
	{
		if( o == null )
			return v; 
	...
	{
		return new XValue( mType.family() , obj );
	}
	@Override
