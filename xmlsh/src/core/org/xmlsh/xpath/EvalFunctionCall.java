...
public class EvalFunctionCall extends ExtensionFunctionCall {
    private static Logger mLogger = LogManager
            .getLogger(EvalFunctionCall.class);
    ...
    public Sequence call(XPathContext context, Sequence[] arguments)
        ...
        SequenceIterator args = arguments.length > 1 ? arguments[1].iterate()
                : null;
        ...
        try {
            ...
            // set stdin
            if (context != null) {
                VariableInputPort iPort = new VariableInputPort(new XVariable(
                        "_in", new XValue(contextItem)));
            ...
            if (oValue == null || oValue.asXdmValue() == null )
                return null;
            return oValue.asXdmValue().getUnderlyingValue();
        } catch (Exception e) {
