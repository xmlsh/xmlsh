...
public class Modules implements
   ...
   *
   */
  public boolean importModule(Shell shell, String prefix, IModule mod,
      List<XValue> init) throws IOException, CoreException {
    ...
    if(!mModules.containsValue(mod)) {
      ...
      try {
        ...
        /*
         * THis isnt necessarily bad - it means a module name cant be fully
         * resolved without loading it
         * and that a module may be loaded and initialized many times - fixing
         * that here doesnt sovle it
         * as the same thing can happen byh other means, different threads,
         * multiple paths to the same module etc.
         *
         * Ideally we would have a global module resolution module but that is
