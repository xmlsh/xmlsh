...
public class ShellConstants {
  ...
  /**
   * Must call initialize atleast once, protects against multiple
   * initializations
   */
  public static void initialize() {
    ...
    String logging = Shell
        .getSystemProperty(ShellConstants.ENV_XDISABLE_LOGGING);
    ...
    SystemEnvironment.getInstance().setProperty(ShellConstants.PROP_USER_DIR,
        System.getProperty(ShellConstants.PROP_USER_DIR));
