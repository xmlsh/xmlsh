...
public class startsWith extends BuiltinFunctionCommand {
    ...
    public XValue run(Shell shell, List<XValue> args) throws UnexpectedException, XPathException,
        ...
        if (args.size() != 2)
            throw new InvalidArgumentException("usage  startsWith(string str)");
        String str = args.get(0).toString();
        String search = args.get(1).toString();
        return new XValue(str.startsWith(search));
    }
