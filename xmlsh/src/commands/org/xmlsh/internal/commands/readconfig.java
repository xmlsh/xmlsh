...
public class readconfig extends XCommand {
  public static org.apache.logging.log4j.Logger mLogger = LogManager
      .getLogger();

  private final class IniConfigParser extends TextConfigParser {
    @Override
    protected XValue parseValue(String currentSection, String name,
  ...
  public int run(List<XValue> args) throws Exception {
    ...
    Options opts = new Options(
        "format:,file:,+r=replace,default=default-section:,defaults=default-values:",
    ...
    InputPort in = opts.hasOpt("file") ? getInput(opts.getOptValue("file"))
        : getStdin();
