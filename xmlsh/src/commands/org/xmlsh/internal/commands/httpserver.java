...
public class httpserver extends XCommand {
  ...
  public class MyHandler implements HttpHandler {
    ...
    MyHandler(Shell shell, boolean chunked, String getFunc, String putFunc,
        String postFunc) throws CoreException {
    ...
    public void handle(HttpExchange http) throws IOException {
      ...
      try {
        ...
        // System.out.println("Got request in thread: " +
        ...
        if(method.equals("GET"))
          ...
          cmd = mPut;
        else if(method.equals("POST") && mPost != null)
          cmd = mPost;
    ...
    private void execute(ICommandExpr cmd, URI uri, InputStream is,
        OutputStream os, XValue headers)
  ...
  public int run(List<XValue> args)
      throws UnknownOption, IOException, CoreException {
  ...
  private int start(Options opts) throws IOException, CoreException {
    ...
    mServer.createContext(context,
        new MyHandler(getEnv().getShell(), bChunk, get, put, post));
