...
public class xtype extends BuiltinCommand {
  ...
  public int run(List<XValue> args) throws Exception {
    Options opts = new Options("v:,s=simple,j=java",
  ...
  void printType(PrintWriter w, XValue arg, boolean bSimple, boolean bJava)
      throws InvalidArgumentException, IOException, CoreException,
      SaxonApiException {
