...
public class ec2AssociateAddress extends AWSEC2Command {
  ...
  private int associate(String instance, String ip)
    ...
    AssociateAddressRequest request = new AssociateAddressRequest(instance,
        raw_ip);
  ...
  private void writeResult(AssociateAddressResult result)
      throws IOException, XMLStreamException, SaxonApiException, CoreException {
