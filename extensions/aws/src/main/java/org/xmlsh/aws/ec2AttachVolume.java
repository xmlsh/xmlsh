...
public class ec2AttachVolume extends AWSEC2Command {
  ...
  private int attach(String volume, String instance, String device)
      throws IOException, XMLStreamException, SaxonApiException,
      InterruptedException, CoreException {

    AttachVolumeRequest request = new AttachVolumeRequest(volume, instance,
        device);
    ...
    do {
      try {
        result = getAWSClient().attachVolume(request);
        break;
  ...
  private void writeResult(AttachVolumeResult result)
