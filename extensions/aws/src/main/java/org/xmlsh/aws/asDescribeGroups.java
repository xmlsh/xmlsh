...
public class asDescribeGroups extends AWSASCommand {
  ...
  private void write(AutoScalingGroup group) throws XMLStreamException {
    ...
    writeStringList("termination-policies", "termination-policy", "name",
  ...
  private void writeTagDescriptions(List<TagDescription> tags)
  ...
  private void writeTagDescription(TagDescription tag)
      throws XMLStreamException {
    startElement("tag");
  ...
  private void writeSuspendedProcesses(
      List<SuspendedProcess> suspendedProcesses) throws XMLStreamException {
  ...
  private void writeSuspendedProcess(SuspendedProcess proc)
      throws XMLStreamException {
  ...
  private void writeELBNames(List<String> loadBalancerNames)
      throws XMLStreamException {
    writeStringList("elb-names", "elb", "name", loadBalancerNames);

  }

  private void writeInstances(List<Instance> instances)
      throws XMLStreamException {
  ...
  private void writeMetrics(List<EnabledMetric> enabledMetrics)
      throws XMLStreamException {
