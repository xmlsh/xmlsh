...
public class ddbDeleteItem extends AWSDDBCommand {
  ...
  public int run(List<XValue> args) throws Exception {
    Options opts = getOptions(sTABLE_OPTIONS, sKEY_OPTIONS, sCONDITION_OPTIONS,
        sRETURN_OPTIONS);
    ...
    int ret = -1;
    ret = delete(tableName, attrs, opts.getOptString("condition", null),
        opts.getOptString("return-values", null));

    return ret;

  }

  private int delete(String tableName, Map<String, AttributeValue> key,
      String condition, String returnValues)
