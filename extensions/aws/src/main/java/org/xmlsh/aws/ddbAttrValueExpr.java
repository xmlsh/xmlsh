  ...
  public XValue run(Shell shell, List<XValue> args) throws Exception {
    ...
    case 0:
      throw new InvalidArgumentException(
          "Required arguments: " + getName() + " expr ... ");
    case 1:
      return XValue.newXValue(
          DDBTypes.addValuePrefix(DDBTypes.parseAttrValueExpr(args.get(0))));
    case 2:
    ...
    default:
      return XValue.newXValue(
          DDBTypes.addValuePrefix(DDBTypes.parseAttrValueExprs(args)));
