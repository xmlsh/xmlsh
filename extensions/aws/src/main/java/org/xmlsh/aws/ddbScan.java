...
public class ddbScan extends AWSDDBCommand {
  ...
  public int run(List<XValue> args) throws Exception {
    ...
    Options opts = getOptions(sTABLE_OPTIONS, sKEY_OPTIONS, sATTR_EXPR_OPTIONS,
        sCONSISTANT_OPTS,
  ...
  private int scan(Options opts)
    ...
    do {
      ...
      metrics.add(new RequestMetrics(result.getCount(),
          result.getScannedCount(), result.getConsumedCapacity()));
