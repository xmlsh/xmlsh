...
public class ec2DescribeImageAttribute extends AWSEC2Command {
  ...
  private int describe(String ami_id, Options opts)
    ...
    DescribeImageAttributeResult result = getAWSClient()
  ...
  private void writeImageAttribute(ImageAttribute imageAttribute)
    ...
    List<BlockDeviceMapping> deviceMappings = imageAttribute
