...
public class sdbPutAttributes extends AWSSDBCommand {
  ...
  private int put(String domain, String item, List<XValue> args,
      String updateName, String updateExists, boolean bReplace, boolean bQuiet)
    ...
    PutAttributesRequest request = new PutAttributesRequest(domain, item,
        attributes, cond);

    traceCall("putAttributes");

    getAWSClient().putAttributes(request);
