...
public class sdbGetAttributes extends AWSSDBCommand {
  ...
  private int getAttributes(String domainName, String itemName,
      boolean bConsistantRead)
    ...
    GetAttributesRequest getAttributesRequest = new GetAttributesRequest(
        domainName, itemName).withConsistentRead(bConsistantRead);

    traceCall("getAttributes");

    GetAttributesResult result = getAWSClient()
  ...
  private void writeItem(String itemName, GetAttributesResult result)
