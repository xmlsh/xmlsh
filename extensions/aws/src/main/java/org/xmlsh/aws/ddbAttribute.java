...
public class ddbAttribute extends AbstractBuiltinFunction {
  ...
  public XValue run(Shell shell, List<XValue> args) throws Exception {
    ...
    case 2:
      return XValue
          .newXValue(DDBTypes.parseAttrNameValue(args.get(0), args.get(1)));
    case 3:
      return XValue.newXValue(
          DDBTypes.parseAttrNameValue(args.get(0), args.get(1), args.get(2)));
    default:
    case 0:
      throw new InvalidArgumentException(
          "Unexpected arguments: Usage: " + getName() + " [type [value]");
    }
